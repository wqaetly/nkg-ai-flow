  ...
  "zh-CN": {
    ...
    nodes: {
      ...
      compensation: {
        ...
        stackCount: "栈内数量",
        updatedAt: "更新时间",
        registeredFlowId: "注册流程 ID",
        registeredFlowVersion: "注册流程版本",
        registeredRunId: "注册运行 ID",
        registeredNodeId: "注册节点 ID",
      ...
      circuit_breaker: {
        ...
        status: "状态",
        previousStatus: "前一状态",
        statusChanged: "状态是否变化",
        transitionReason: "状态变化原因",
      ...
      checkpoint: {
        ...
        mode: "模式",
        label: "标签",
        checkpointFlowId: "检查点 Flow ID",
        checkpointRunId: "检查点运行 ID",
        checkpointNodeId: "检查点节点 ID",
        version: "版本",
        savedAt: "保存时间",
        loadedAt: "读取时间",
        expiresAt: "过期时间",
      ...
      foreach_begin: {
        ...
        iterationKey: "迭代定位键",
        iterationSequence: "迭代序号",
        effectiveConcurrency: "有效并发数",
        effectiveBatchSize: "有效批大小",
        concurrencyLimited: "是否限流",
        batchCount: "批次数量",
        batchIndex: "当前批次索引",
        batchStart: "当前批次起点",
        batchEnd: "当前批次终点",
        batchItemCount: "当前批次数量",
        batchPartial: "是否部分批次",
        batchRanges: "批次范围",
      },
      foreach_end: {
      ...
      rollback: {
        ...
        failures: "失败项",
        pending: "待处理项",
        registeredFlowIds: "注册流程 ID 列表",
        registeredFlowVersions: "注册流程版本列表",
        registeredRunIds: "注册运行 ID 列表",
        registeredNodeIds: "注册节点 ID 列表",
        status: "状态",
        mode: "模式",
        successPath: "成功路径",
        successValues: "成功值",
