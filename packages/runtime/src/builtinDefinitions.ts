...
export function getBuiltinNodeDefinitions(
  ...
  return [
    ...
    retryStateNode.definition,
    resumePointNode.definition,
    rollbackNode.definition,
    scheduleWindowNode.definition,
    schemaGuardNode.definition,
    schemaTransformNode.definition,
    selectPathNode.definition,
    semaphoreNode.definition,
    setPathNode.definition,
    sliceItemsNode.definition,
    sortItemsNode.definition,
    splitTextNode.definition,
